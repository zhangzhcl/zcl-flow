...
var AuthController = function () {
        ...
        AuthController_1.prototype.changePassword = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auth.changePassword(user.sub, dto)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    (function () {
        ...
        _login_decorators = [(0, auth_guard_1.Public)(), (0, common_1.Post)('login')];
        _me_decorators = [(0, common_1.Get)('me')];
        _changePassword_decorators = [(0, common_1.Post)('change-password'), (0, common_1.HttpCode)(204)];
...
var UsersController = function () {
    var _classDecorators = [(0, auth_guard_1.AdminOnly)(), (0, common_1.Controller)('users')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.create = function (dto) {
            return this.users.create(dto);
        };
        UsersController_1.prototype.update = function (id, dto, actor) {
            return this.users.update(id, dto, actor.sub);
        };
        UsersController_1.prototype.resetPassword = function (id) {
            return this.users.resetPassword(id);
        };
        UsersController_1.prototype.remove = function (id, actor) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.users.remove(id, actor.sub)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
