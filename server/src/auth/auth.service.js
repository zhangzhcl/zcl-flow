...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(repo, jwt, config) {
            this.repo = repo;
            this.jwt = jwt;
            this.config = config;
        ...
        AuthService_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                var count, username, configured, password;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            configured = this.config.get('ADMIN_PASSWORD', '');
                            password = configured || (0, password_util_1.generatePassword)(12);
                        ...
                        case 2:
                            _a.sent();
                            this.logger.warn('==============================================');
                            this.logger.warn("Initial admin account created: ".concat(username));
                            this.logger.warn(configured
                                ? 'Password: taken from ADMIN_PASSWORD in .env'
                                : "Password: ".concat(password, "  (generated once, please change after login)"));
                            this.logger.warn('==============================================');
                            return [2 /*return*/];
                    }
                });
        ...
        AuthService_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.repo.findOneBy({ username: dto.username })];
                        case 1:
                            user = _b.sent();
                            if (!user || !(0, password_util_1.verifyPassword)(dto.password, user.passwordHash)) {
                        ...
                        case 3: return [2 /*return*/, (_a.token = _b.sent(),
                                _a.user = (0, user_entity_1.toUserView)(user),
                                _a)];
                    }
                });
            });
        ...
        AuthService_1.prototype.findById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.repo.findOneBy({ id: id })];
                });
            });
        };
        AuthService_1.prototype.profile = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, (0, user_entity_1.toUserView)(user)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!user)
                                throw new common_1.UnauthorizedException('Account no longer exists');
                            if (!(0, password_util_1.verifyPassword)(dto.currentPassword, user.passwordHash)) {
                                throw new common_1.BadRequestException('Current password is incorrect');
                            }
                            if (dto.currentPassword === dto.newPassword) {
                                throw new common_1.BadRequestException('New password must differ from the current one');
                            }
                            user.passwordHash = (0, password_util_1.hashPassword)(dto.newPassword);
