...
var AgentsController = function () {
    var _classDecorators = [(0, common_1.Controller)('agents')];
    ...
    var AgentsController = _classThis = /** @class */ (function () {
        function AgentsController_1(agents) {
            this.agents = (__runInitializers(this, _instanceExtraInitializers), agents);
        }
        AgentsController_1.prototype.findAll = function (user) {
            return this.agents.findAll(user.sub);
        };
        AgentsController_1.prototype.create = function (dto, user) {
            return this.agents.create(dto, user.sub);
        };
        AgentsController_1.prototype.findOne = function (id, user) {
            return this.agents.findOne(id, user.sub);
        };
        AgentsController_1.prototype.update = function (id, dto, user) {
            return this.agents.update(id, dto, user.sub);
        };
        AgentsController_1.prototype.remove = function (id, user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.agents.remove(id, user.sub)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        AgentsController_1.prototype.listConversations = function (id, user) {
            return this.agents.listConversations(id, user.sub);
        };
        AgentsController_1.prototype.createConversation = function (id, dto, user) {
            return this.agents.createConversation(id, dto, user.sub);
        };
        AgentsController_1.prototype.getConversation = function (id, conversationId, user) {
            return this.agents.getConversation(id, conversationId, user.sub);
        };
        AgentsController_1.prototype.chat = function (id, dto, user) {
    ...
    (function () {
        ...
        _listConversations_decorators = [(0, common_1.Get)(':id/conversations')];
        _createConversation_decorators = [(0, common_1.Post)(':id/conversations')];
        _getConversation_decorators = [(0, common_1.Get)(':id/conversations/:conversationId')];
        _chat_decorators = [(0, common_1.Post)(':id/chat')];
