...
var GenerateWorkflowDto = function () {
    var _a;
    var _prompt_decorators;
    var _prompt_initializers = [];
    var _prompt_extraInitializers = [];
    return _a = /** @class */ (function () {
            function GenerateWorkflowDto() {
                this.prompt = __runInitializers(this, _prompt_initializers, void 0);
                __runInitializers(this, _prompt_extraInitializers);
            }
            return GenerateWorkflowDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _prompt_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(2000)];
